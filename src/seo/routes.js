...
export function isTopicRoute(route) {
  return route.type === 'topic';
}

export function getAppShell(route) {
  return isTopicRoute(route) ? 'topic' : 'standalone';
}
...
export const navItems = [
  ...
  { id: 'comparison', path: '/kurcz-vs-skurcz', label: 'Kurcz czy skurcz', icon: 'M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6', priority: 2 },
