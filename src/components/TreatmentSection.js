    ...
    template: `
      <section id="treatment" class="py-20 bg-gray-50">
        <div class="container mx-auto px-6">
          ...
          <div class="max-w-6xl mx-auto mb-16 bg-red-50 rounded-xl shadow-soft overflow-hidden border-l-4 border-red-500 transform transition-all duration-300 hover:shadow-md">
            <div class="p-6 md:p-8">
              <div class="flex items-center mb-6">
                ...
                <h2 class="text-2xl md:text-3xl font-bold text-red-800 leading-tight">Natychmiastowa pomoc przy kurczach</h2>
              </div>
              
              <!-- Emergency Cards Grid -->
              <div class="grid md:grid-cols-3 gap-6 mb-6">
                <div class="card p-5 border-l-4 border-red-400 hover-lift">
                  <div class="flex items-start">
                    <div class="icon-circle icon-circle-md bg-red-100 text-red-600 mr-3 flex-shrink-0 flex items-center justify-center">
                      <span class="font-semibold">1</span>
                    </div>
                    <div>
                      <h3 class="card-title mb-2">Rozciąganie</h3>
                ...
                <div class="card p-5 border-l-4 border-red-400 hover-lift">
                  <div class="flex items-start">
                    ...
                    <div>
                      <h3 class="card-title mb-2">Masaż</h3>
                ...
                <div class="card p-5 border-l-4 border-red-400 hover-lift">
                  <div class="flex items-start">
                    ...
                    <div>
                      <h3 class="card-title mb-2">Nawodnienie</h3>
          ...
          <div class="max-w-6xl mx-auto text-center mb-16">
            <span class="section-subtitle">Leczenie i Profilaktyka</span>
          ...
          <div class="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div>
              <h3 class="component-title text-center md:text-left">
                Natychmiastowa ulga
              </h3>
                ...
                <template x-for="(item, index) in accordion" :key="item.id">
                  <div class="border-b border-gray-200 last:border-0">
                    <button 
                      ...
                      class="w-full text-left px-5 py-4 focus:outline-none flex justify-between items-center transition-colors duration-200"
                    ...
                    <div 
                      ...
                      class="px-5 py-4 bg-blue-50 border-t border-blue-100"
                    >
              ...
              <div class="card shadow-soft p-6">
                <ul class="space-y-5">
                  <li class="feature-list-item">
                    <div class="icon-circle icon-circle-sm bg-blue-100 text-blue-600">
                      <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                      </svg>
                    </div>
                    <div class="flex-1">
                      <h4 class="card-title mt-0">Utrzymuj odpowiednie nawodnienie</h4>
                  ...
                  <li class="feature-list-item">
                    ...
                    <div class="flex-1">
                      <h4 class="card-title mt-0">Zrównoważona dieta</h4>
                  ...
                  <li class="feature-list-item">
                    ...
                    <div class="flex-1">
                      <h4 class="card-title mt-0">Regularne rozciąganie</h4>
                  ...
                  <li class="feature-list-item">
                    ...
                    <div class="flex-1">
                      <h4 class="card-title mt-0">Stopniowe zwiększanie intensywności ćwiczeń</h4>
          ...
          <div class="mt-16 max-w-6xl mx-auto bg-blue-50 rounded-xl shadow-soft overflow-hidden p-6 sm:p-8">
            <div class="flex flex-col sm:flex-row items-start">
              ...
              <div>
                <h4 class="text-xl font-semibold text-gray-900 mb-4">Kiedy skontaktować się z lekarzem?</h4>
                <ul class="space-y-3 text-gray-600">
                  <li class="feature-list-item">
                    <svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                    <span>Skurcze są częste i nawracające, mimo stosowania metod profilaktyki</span>
                  </li>
                  <li class="feature-list-item">
                    <svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                    <span>Skurcze są bardzo silne, długotrwałe lub uniemożliwiają normalne funkcjonowanie</span>
                  </li>
                  <li class="feature-list-item">
                    <svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                    <span>Skurczom towarzyszy silny ból, obrzęk, zaczerwienienie lub widoczne zniekształcenie mięśnia</span>
                  </li>
                  <li class="feature-list-item">
                    <svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                    <span>Skurcze pojawiają się po urazie lub wystąpieniu innych niepokojących objawów</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <!-- Disclaimer -->
          <div class="mt-12 max-w-6xl mx-auto text-center">
            <div class="p-4 bg-gray-50 border border-gray-200 rounded-lg">
              <p class="text-sm text-gray-600">
                <svg class="w-4 h-4 inline-block mr-1 text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                </svg>
                <strong>Zastrzeżenie:</strong> Informacje zawarte na tej stronie mają charakter edukacyjny i nie zastępują profesjonalnej porady medycznej.
                W przypadku problemów zdrowotnych zawsze skonsultuj się z lekarzem lub innym wykwalifikowanym pracownikiem służby zdrowia.
              </p>
            </div>
          </div>
        </div>
