...
export default function () {
  return {
    ...
    featuredLandingLinks: footerLandingLinks.slice(0, 6),
      ...
      <footer id="footer" class="bg-gray-900 text-white pt-20 pb-10 relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16 max-w-7xl mx-auto">
              ...
              <ul class="space-y-4 text-sm font-medium">
                ...
                <li>
                  ...
                  >
                    ...
                    <span class="group-hover:translate-x-1 transition-transform duration-300">Poradniki</span>
                  </a>
                </li>
            ...
            <div>
              <h3 class="font-heading text-sm font-bold tracking-wider uppercase text-gray-300 mb-6 relative inline-block">
                <a href="/poradniki" class="text-gray-300 hover:text-primary-300 no-underline">Poradniki</a>
                <span class="absolute -bottom-2 left-0 w-1/2 h-0.5 bg-primary-500 rounded-full"></span>
              </h3>
              <ul class="space-y-3 text-sm">
                <li>
                  <a href="/poradniki" class="text-primary-300 hover:text-primary-200 transition-colors no-underline font-medium">Wszystkie poradniki →</a>
                </li>
                <template x-for="link in featuredLandingLinks" :key="link.path">
                  <li>
