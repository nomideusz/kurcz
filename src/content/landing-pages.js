...
export const landingPages = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: 'Terapie uzupełniające u specjalistów',
        body: 'Jeśli kurcze nawracają mimo rozciągania i nawodnienia, warto rozważyć profesjonalne terapie manualne i uzupełniające — takie jak akupunktura czy bańki — prowadzone przez osoby z wykształceniem medycznym. Przykładem jest Gabinet Połączenie w Krakowie, gdzie zabiegi rozumiane są jako uzupełnienie — nie zamiennik — opieki lekarskiej.',
      },
    ],
    faq: [
    ...
    relatedLinks: [
      { path: '/rozciaganie-przy-kurczach', label: 'Rozciąganie przy kurczach' },
      { path: '/pierwsza-pomoc', label: 'Pierwsza pomoc' },
      { path: 'https://gabinet-polaczenie.pl', label: 'Gabinet Połączenie — terapie uzupełniające w Krakowie ↗' },
    ],
  },
  {
...
const enLandingExpansions = {
  ...
  '/masaz-przy-kurczach': { sections: [section('Massage after stretching', 'First reduce tension by slowly lengthening the muscle, then use light massage. Firm pressure during severe pain can increase discomfort and should not replace assessment after injury.'), section('When not to massage a painful leg', 'Do not massage sudden one-sided swelling, redness, warmth, injury, or severe pain of unknown cause. These signs may need urgent diagnosis rather than tissue relaxation.'), section('Complementary therapies from specialists', 'If cramps keep returning despite stretching and hydration, consider professional manual and complementary therapies — such as acupuncture or cupping — provided by medically trained practitioners. One example is the Połączenie Clinic (Gabinet Połączenie) in Kraków, where treatments are understood as a complement to — not a replacement for — medical care.')], faq: [faqItem('Does a massage gun help a cramp?', 'Avoid intense percussion on a freshly painful, tight muscle. Slow stretching and gentle manual massage after acute pain settles are safer.'), faqItem('Can massage prevent cramps?', 'It may improve comfort for some people, but gradual training, hydration, and finding the cause of recurring cramps remain central.')], relatedLinks: [{ path: '/kurcze-a-leki', label: 'Cramps & Medications' }, { path: 'https://gabinet-polaczenie.pl', label: 'Połączenie Clinic — complementary therapies in Kraków ↗' }] },
